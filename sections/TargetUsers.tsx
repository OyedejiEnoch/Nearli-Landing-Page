...
export function TargetUsers() {
  ...
  return (
    <section ref={containerRef} id='targetUsers' className="py-20 md:py-28 lg:py-36 bg-[#FDFAF6] overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16 lg:mb-24">
          <div className="text-[10px] font-bold tracking-[0.2em] uppercase text-[#120E2E] mb-6">
            Who It&apos;s For
          </div>
          <h2 className="target-heading text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-[#1a1a1a] mb-6 tracking-tight">
            ...
            <div className="overflow-hidden inline-block mr-4">
              <span className="word-reveal inline-block text-[#120E2E]">EVERY</span>
            </div>
            <br />
          ...
          <p className="target-desc text-base md:text-lg text-[#6B6B8A] max-w-lg mx-auto leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px max-w-7xl mx-auto bg-[#C5BFDA] border border-[#C5BFDA]">
          {users.map((user, index) => (
            <div 
              ...
              className="bg-white p-8 lg:p-10 group hover:bg-[#F0EBE2] transition-colors duration-500"
            >
              ...
              <div className="flex flex-wrap gap-2">
                {user.examples.map((example, i) => (
                  <span 
                    key={i}
                    className="px-3 py-1.5 border border-[#C5BFDA] text-[#777] text-[10px] rounded-full font-bold uppercase tracking-wider group-hover:bg-[#120E2E] group-hover:text-white group-hover:border-[#120E2E] transition-all duration-500"
                  >
                    {example}
                  </span>
                ))}
        ...
        <div className="success-container mt-24 max-w-6xl mx-auto">
          <div className="bg-[#120E2E] p-10 md:p-14 lg:p-16 text-white overflow-hidden">
            <div className="grid lg:grid-cols-3 gap-10 lg:gap-12 items-center">
              <div className="lg:col-span-2">
                <div className="text-[10px] font-bold text-[#C5BFDA] mb-8 uppercase tracking-[0.3em]">Success Story</div>
                ...
                <p className="text-base md:text-xl text-[#C5BFDA] leading-relaxed mb-10 font-light">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-10 h-px bg-[#C5BFDA]"></div>
                  <div>
                    <div className="font-bold text-base tracking-widest uppercase">Joke M.</div>
                    <div className="text-xs text-[#C5BFDA] font-medium tracking-widest uppercase">Cake vendor, Lagos</div>
                  </div>
                </div>
              </div>
