    ...
    <div ref={containerRef} className="relative lg:pl-8 [perspective:1000px]">
      <div ref={phoneRef} className="relative mx-auto w-full max-w-[340px] will-change-transform">
          ...
          <div className="relative overflow-hidden rounded-[2.25rem] bg-[#F4F2F8]">
            ...
            <div className="flex items-center justify-between bg-white px-4 py-3.5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-base font-bold tracking-tight text-[#0D1020]">Ahiver</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="flex h-9 w-9 items-center justify-center rounded-full border border-[#E2E6F0]">
                  <Bell className="h-4 w-4 text-[#5C6490]" />
                </div>
                <div className="flex h-9 w-9 items-center justify-center rounded-full border border-[#E2E6F0]">
                  <ShoppingBag className="h-4 w-4 text-[#5C6490]" />
                </div>
                <div
                  className="h-9 w-9 rounded-full border-2 border-white shadow-sm"
                  style={{ background: '#7A2B3D' }}
                />
              </div>
            </div>
            ...
            <div className="h-[440px] overflow-hidden px-3 pb-3 pt-3">
              ...
              <div className="mb-4 flex items-center justify-between rounded-2xl bg-white p-3 shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <div className="text-[13px] font-bold leading-tight text-[#0D1020]">
                      Ibadan South West, Oyo
                    </div>
                    <div className="text-[11px] text-[#5C6490]">3 businesses nearby</div>
                  </div>
                </div>
                <div
              ...
              <div className="mb-2 flex items-center gap-2">
                ...
                <h3 className="text-lg font-bold tracking-tight text-[#0D1020]">
                  Discover Curated Stores
                </h3>
              </div>
              <p className="mb-4 text-[12px] leading-relaxed text-[#5C6490]">
              ...
              <div ref={cardRef} className="overflow-hidden rounded-2xl bg-white shadow-md will-change-transform">
                <div className="relative h-40">
                  ...
                  <div className="absolute -bottom-4 right-3 flex items-center gap-1 rounded-full bg-white px-3 py-1.5 shadow-md">
                    ...
                    <span className="text-[11px] font-bold text-[#0D1020]">1.7km</span>
                  </div>
                </div>
                <div className="px-4 pb-4 pt-7">
                  <div className="flex items-center gap-1.5">
                    <span className="text-[15px] font-bold text-[#0D1020]">Test store 5</span>
                    <BadgeCheck className="h-4 w-4" style={{ color: PURPLE }} />
                  </div>
                  <div className="mt-1 flex items-center gap-1 text-[11px] text-[#5C6490]">
            ...
            {/* Bottom tab bar */}
            <div className="absolute bottom-0 left-0 right-0 flex items-center justify-around border-t border-[#E2E6F0] bg-white/95 px-2 pb-3 pt-2.5 backdrop-blur-sm">
              <TabItem icon={Home} label="Home" active />
              <TabItem icon={Compass} label="Explore" />
              {/* Center search */}
              <div className="-mt-6 flex flex-col items-center">
                <div
                  className="flex h-12 w-12 items-center justify-center rounded-full ring-4 ring-[#E0EBFF]"
                  style={{ background: NAVY }}
                >
        ...
        <div
          ...
          className="absolute -left-5 top-28 rounded-2xl border border-[#E2E6F0] bg-white p-3.5 shadow-[0_20px_50px_rgba(18,14,46,0.12)] will-change-transform"
        >
          <div className="mb-1 flex items-center gap-1.5">
            <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-emerald-500" />
            <span className="text-[9px] font-bold uppercase tracking-widest text-emerald-600">Live</span>
          </div>
          <div className="text-[10px] font-bold uppercase tracking-widest text-[#5C6490]">New followers</div>
          <div className="text-sm font-bold" style={{ color: NAVY }}>+23 today</div>
        </div>

        <div
          ref={floatingCard2Ref}
          className="absolute -right-5 bottom-32 rounded-2xl border border-[#E2E6F0] bg-white p-3.5 shadow-[0_20px_50px_rgba(18,14,46,0.12)] will-change-transform"
        >
          <div className="text-[10px] font-bold uppercase tracking-widest text-[#5C6490]">Sales this week</div>
...
function TabItem({
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <Icon className={`h-5 w-5 ${active ? 'text-[#0D1020]' : 'text-[#b6b2c4]'}`} />
      <span className={`text-[9px] font-semibold ${active ? 'text-[#0D1020]' : 'text-[#b6b2c4]'}`}>
        {label}
      </span>
    </div>
  );
